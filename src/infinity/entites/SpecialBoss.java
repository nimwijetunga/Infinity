...
public class SpecialBoss extends Boss{
	 ...
	 */
	public SpecialBoss(Main main, double x, double y, int width, int height, double health, double damage) {
